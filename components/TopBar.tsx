    ...
    <div className='absolute top-0 bg-white z-50 w-full rounded-b-xl flex justify-between h-14'>
      ...
      <div className="parentMost-right flex space-x-4 items-center md:mr-16 mr-4">
        ...
        {isOpen && <div className='absolute right-2 md:right-16 top-[56px] bg-white rounded-lg'>
          <ul className='flex flex-col shadow-md border rounded-lg'>
            <li onClick={()=> router.push('/account')} className='flex text-base bg-indigo-50 text-gray-700 rounded-t-lg hover:bg-gray-900 duration-100 hover:text-white font-semibold ease-out cursor-pointer px-3 py-2 '>My account &nbsp;<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
            </svg></li>
            <li className='flex text-base bg-indigo-50 text-gray-700 rounded-b-lg hover:bg-gray-900 duration-100 hover:text-white font-semibold ease-out cursor-pointer px-3 py-2 '>Coming Soon &nbsp;<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
